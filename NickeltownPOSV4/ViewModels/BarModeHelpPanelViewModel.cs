...
public sealed class BarModeHelpPanelViewModel : ObservableViewModel
{
    ...
    public string HelpText =>
        ...
        + "• Undo Last Transaction sits below the tab board (left side). It shows what will be reversed (item, amount, tab, time), then you enter your PIN to confirm.\n"
